...
@implementation AnotherTableView
...
names = [[NSMutableArray alloc] initWithObjects:@"Todd", @"Andrew", @"Eric", @"Justin", @"Barb",nil];

//	names = [[[NSTimeZone knownTimeZoneNames] sortedArrayUsingSelector:@selector(compare:)] retain];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	NSLog(@"Size of rows is %d", [names count]);
