...
- (void)loadFlickrPhotos
{
    ...
    NSString *urlString = [NSString stringWithFormat:
						@"http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&tags=%@&per_page=30&format=json&nojsoncallback=1",
						   FlickrAPIKey, @"funny"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel  setText:[photoNames objectAtIndex:indexPath.row]];
