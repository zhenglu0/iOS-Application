//
//  CompareBackhandViewController.m
//  Tennis Coach
//
...
#import "CompareBackhandViewController.h"

@interface CompareBackhandViewController ()

@end

@implementation CompareBackhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"tennis-backhand-technique.png"]];
