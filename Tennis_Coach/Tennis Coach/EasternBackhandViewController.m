//
//  EasternBackhandViewController.m
//  Tennis Coach
//
...
#import "EasternBackhandViewController.h"

@interface EasternBackhandViewController ()

@end

@implementation EasternBackhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Eastern backhand.png"]];
