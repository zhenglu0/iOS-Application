//
//  TwoHandedBackhandViewController.m
//  Tennis Coach
//
...
#import "TwoHandedBackhandViewController.h"

@interface TwoHandedBackhandViewController ()

@end

@implementation TwoHandedBackhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Two handed backhand.png"]];
