//
//  SemiWesternForhandViewController.m
//  Tennis Coach
//
...
#import "SemiWesternForhandViewController.h"

@interface SemiWesternForhandViewController ()

@end

@implementation SemiWesternForhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Semi Western.png"]];
