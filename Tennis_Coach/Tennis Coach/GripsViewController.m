...
#import "GripsViewController.h"

@interface GripsViewController ()

@end

@implementation GripsViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Find the grips.png"]];
