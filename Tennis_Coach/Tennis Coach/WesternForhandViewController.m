//
//  WesternForhandViewController.m
//  Tennis Coach
//
...
#import "WesternForhandViewController.h"

@interface WesternForhandViewController ()

@end

@implementation WesternForhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Western Forhand.png"]];
