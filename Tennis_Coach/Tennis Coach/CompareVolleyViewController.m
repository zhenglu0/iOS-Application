...
#import "CompareVolleyViewController.h"

@interface CompareVolleyViewController ()

@end

@implementation CompareVolleyViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"BackhandVolley.png"]];
