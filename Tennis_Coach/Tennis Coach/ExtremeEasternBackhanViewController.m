//
//  ExtremeEasternBackhanViewController.m
//  Tennis Coach
//
...
#import "ExtremeEasternBackhanViewController.h"

@interface ExtremeEasternBackhanViewController ()

@end

@implementation ExtremeEasternBackhanViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Extreme eastern.png"]];
