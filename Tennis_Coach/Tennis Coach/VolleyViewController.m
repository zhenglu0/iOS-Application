...
#import "VolleyViewController.h"

@interface VolleyViewController ()

@end

@implementation VolleyViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Continential grip.png"]];
