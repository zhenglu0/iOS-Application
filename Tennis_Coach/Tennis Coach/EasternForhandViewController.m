//
//  EasternForhandViewController.m
//  Tennis Coach
//
...
#import "EasternForhandViewController.h"

@interface EasternForhandViewController ()

@end

@implementation EasternForhandViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"Eastern Forhand.png"]];
